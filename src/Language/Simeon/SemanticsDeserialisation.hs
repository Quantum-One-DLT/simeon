module Language.Simeon.SemanticsDeserialisation (byteStringToContract) where

import Data.ByteString (ByteString)
import Data.Ratio ((%))
import Language.Simeon.SemanticsTypes (Action(..), Bound(..), Case(..), ChoiceId(..), Contract(..), Observation(..), Party(..), Payee(..), Slot(Slot), Token(..),
                                        ...
                                        ValueId(..),)
import Language.Simeon.Deserialisation (byteStringToInt, byteStringToList, byteStringToPositiveInt, getByteString)
