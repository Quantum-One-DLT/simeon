...
module Language.Simeon.Util where
import           Data.List                       (foldl')
import           Data.Map.Strict                 (Map)
import qualified Data.Map.Strict                 as Map
import           Data.String                     (IsString(..))
import qualified Data.Text                       as T
import           Language.Simeon.Semantics      (Payment(..))
import           Language.Simeon.SemanticsTypes (Input, InputContent(IDeposit), Payee(Party), ValueId(..),
