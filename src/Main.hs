...
import           Language.Simeon.Examples.ZCBG2
import           Language.Simeon.ACTUS.ActusContracts
...
couponBondFor3Month12Percent =
    ...
    When [ Case (Deposit "investor" "investor" bcc (Constant 1000))
        ...
        (Pay "investor" (Party "issuer") bcc (Constant 1000)
            -- after a month expect to receive 10 Bcc interest
...
zeroCouponBond = When [ Case
        (Deposit "investor" "investor" bcc (Constant 850))
        (Pay "investor" (Party "issuer") bcc (Constant 850)
            (When
                [ Case (Deposit "investor" "issuer" bcc (Constant 1000))
                        (Pay "investor" (Party "investor") bcc (Constant 1000) Close)
                ]
                (Slot 1579305589)
                Close
            )
...
couponBondGuaranteed = When [Case (Deposit "investor" "guarantor" bcc (Constant 1030))
    (When [Case (Deposit "investor" "investor" bcc (Constant 1000))
        (Pay "investor" (Party "issuer") bcc (Constant 1000)
            (When [Case (Deposit "investor" "issuer" bcc (Constant 10))
                (Pay "investor" (Party "investor") bcc (Constant 10)
                (Pay "investor" (Party "guarantor") bcc (Constant 10)
                    (When [Case (Deposit "investor" "issuer" bcc (Constant 10))
                        (Pay "investor" (Party "investor") bcc (Constant 10)
                        (Pay "investor" (Party "guarantor") bcc (Constant 10)
                            (When [Case (Deposit "investor" "issuer" bcc (Constant 1010))
                                (Pay "investor" (Party "investor") bcc (Constant 1010)
                                (Pay "investor" (Party "guarantor") bcc (Constant 1010) Close))]
...
couponBondGuaranteedWithAccounts =
    ...
    When [Case (Deposit "party2" "guarantor" bcc (Constant 1030))
        -- then it's same as for simple coupon bond
        (When [Case (Deposit "party1" "party1" bcc (Constant 1000))
            (Pay "party1" (Party "party2") bcc (Constant 1000)
                (When [Case (Deposit "party1" "party2" bcc (Constant 10))
                    (Pay "party1" (Party "party1") bcc (Constant 10)
                        (When [Case (Deposit "party1" "party2" bcc (Constant 10))
                            (Pay "party1" (Party "party1") bcc (Constant 10)
                                (When [Case (Deposit "party1" "party2" bcc (Constant 1010))
                                    (Pay "party1" (Party "party1") bcc (Constant 1010) Close)]
                                (Slot 1571788789)
                                -- if the issues fails to return notional
                                -- guarantor pays from his account and refunds
                                (Pay "party2" (Party "party1") bcc (Constant 1010) Close))
                            )]
                        (Slot 1569196789)
                        -- guarantor pays from his account and refunds
                        (Pay "party2" (Party "party1") bcc (Constant 1020) Close)))]
                (Slot 1566518389)
                -- guarantor pays from his account and refunds
                (Pay "party2" (Party "party1") bcc (Constant 1030) Close)))]
...
couponBondGuaranteedWithoutAccounts =
    -- guarantor deposits a whole payoff amount including interest payments
    When [Case (Deposit "party1" "guarantor" bcc (Constant 1030))
            -- investor deposits 1000 Bcc
        (When [Case (Deposit "party1" "party1" bcc (Constant 1000))
            (Pay "party1" (Party "party2") bcc (Constant 1000)
                (When [Case (Deposit "party1" "party2" bcc (Constant 10))
                        ...
                        (When [Case (Deposit "party1" "party2" bcc (Constant 10))
                            (Pay "party1" (Party "party1") bcc (Constant 10)
                                (When [Case (Deposit "party1" "party2" bcc (Constant 1010))
                                    (Pay "party1" (Party "party1") bcc (Constant 1010) Close)]
                                (Slot 1571788789)
                                (Pay "party1" (Party "party1") bcc (Constant 1010)
                                -- with single account we have to
                                -- manually redistibute money to guarantor
                                (Pay "party1" (Party "guarantor") bcc (Constant 20) Close))))]
                        (Slot 1569196789)
                        (Pay "party1" (Party "party1") bcc (Constant 1020)
                        -- in all the cases
                        (Pay "party1" (Party "guarantor") bcc (Constant 10) Close))))]
                (Slot 1566518389)
                -- here as well
                (Pay "party1" (Party "party1") bcc (Constant 1030) Close)))]
        (Slot 1563839989)
        -- and thes are only 3 payments
        (Pay "party1" (Party "guarantor") bcc (Constant 1030) Close))]
    (Slot 1563839989) Close


{- Simply swap two payments between parties -}
swapExample =
    When [ Case (Deposit acc1 "party1" bcc (Constant 500))
            -- when 1st party committed, wait for 2nd
            (When [ Case (Deposit acc2 "party2" bcc (Constant 300))
                (Pay acc1 (Party "party2") bcc (Constant 500)
                (Pay acc2 (Party "party1") bcc (Constant 300) Close))
                ] date1
            -- if a party dosn't commit, simply Close to the owner
            Close)
          , Case (Deposit acc2 "party2" bcc (Constant 300))
            -- if 2nd party committed first wait for 1st
            (When [ Case (Deposit acc1 "party1" bcc (Constant 500))
                -- we can just pay a diff between account and refund
                (Pay acc1 (Account acc2) bcc (Constant 200) Close)
            ] date1
            -- if a party dosn't commit, simply Close to the owner
            Close)
...
swapSingleAccount =
    When [ Case (Deposit acc1 "party1" bcc (Constant 500))
            (When [ Case (Deposit acc1 "party2" bcc (Constant 300))
                (Pay acc1 (Party "party2") bcc (Constant 500)
                (Pay acc1 (Party "party1") bcc (Constant 300) Close))
                ] (Slot date1)
            -- refund to the 1st party
            (Pay acc1 (Party "party1") bcc (Constant 500) Close))
         , Case (Deposit acc1 "party2" bcc (Constant 300))
            (When [ Case (Deposit acc1 "party1" bcc (Constant 500))
                (Pay acc1 (Party "party2") bcc (Constant 500)
                (Pay acc1 (Party "party1") bcc (Constant 300) Close))
            ] (Slot date1)
            -- refund to the 2nd party
            (Pay acc1 (Party "party2") bcc (Constant 300) Close))
...
swapGuaranteedExample =
    When [ Case (Deposit acc3 "guarantor" bcc (Constant 800))
        (When [
            Case (Deposit acc1 "party1" bcc (Constant 500))
                (When [ Case (Deposit acc2 "party2" bcc (Constant 300))
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    (Pay acc2 (Party "party1") bcc (Constant 300) Close))
                    ] date1
                    -- just transfer from guarantor account to party1 and refund to owner
                    (Pay acc3 (Account acc1) bcc (Constant 300) Close))
            , Case (Deposit acc2 "party2" bcc (Constant 300))
                (When [ Case (Deposit acc2 "party2" bcc (Constant 500))
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    (Pay acc2 (Party "party1") bcc (Constant 300) Close))
                    ] date1
                    -- just transfer from guarantor account to party1 and refund to owner
                    (Pay acc3 (Account acc2) bcc (Constant 500) Close))
            ] (date1 - gracePeriod)
...
swapSingleAccountGuaranteedExample =
    When [ Case (Deposit acc1 "guarantor" bcc (Constant 800))
        (When [
            Case (Deposit acc1 "party1" bcc (Constant 500))
                (When [ Case (Deposit acc1 "party2" bcc (Constant 300))
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    (Pay acc1 (Party "party1") bcc (Constant 300)
                    (Pay acc1 (Party "guarantor") bcc (Constant 800) Close)))
                    ] date1
                    -- with single account all payments must be duplicated
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    (Pay acc1 (Party "party1") bcc (Constant 300)
                    (Pay acc1 (Party "guarantor") bcc (Constant 500) Close)))
                )
            , Case (Deposit acc2 "party2" bcc (Constant 300))
                (When [ Case (Deposit acc2 "party2" bcc (Constant 500))
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    ...
                    (Pay acc1 (Party "party2") bcc (Constant 500)
                    (Pay acc1 (Party "party1") bcc (Constant 300)
                    (Pay acc1 (Party "guarantor") bcc (Constant 00) Close)))
                )
            ] (date1 - gracePeriod)
