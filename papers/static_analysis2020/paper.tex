...
\email{pablo.lamela@tbco.io, david.smith@tweag.io, simon.thompson@tbco.io}  \and
...
% For example, in the case of Simeon, contracts are typically interactive
% and must deal with inputs arriving from different users in different
% orders, and sometimes not arriving at all. In addition, Simeon allows
