...
* Bcc cannot be committed after time 10
* Bcc cannot be redeemed before time 100
* Bcc can be redeemed after time 100
...
* Alice has from time 0 to time 10 to make a deposit of 500 bcc.
...
* Bcc can be claimed at any time after commitment and before time 100 is
reached.
* Bcc cannot be redeemed before time 100.
...
* Alice has from time 0 to time 10 to deposit 500 bcc.
...
* Bcc can be redeemed after block 100
