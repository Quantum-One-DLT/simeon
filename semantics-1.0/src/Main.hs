...
main :: IO ()
main = do
    print $ zcbSimeon 100 12345 1 2
    let c = SPJ.One
    print $ translateSPJContractToSimeon 1 8 (SPJ.One)
    print $ translateSPJContractToSimeon 1 8 (SPJ.Give $ SPJ.One)
    defaultMain (testGroup "Simeon Tests" tests)
